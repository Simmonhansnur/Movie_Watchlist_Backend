...
-- AddForeignKey
ALTER TABLE "WatchListItem" ADD CONSTRAINT "WatchListItem_moiveId_fkey" FOREIGN KEY ("moiveId") REFERENCES "Movie"("id") ON DELETE CASCADE ON UPDATE CASCADE;
